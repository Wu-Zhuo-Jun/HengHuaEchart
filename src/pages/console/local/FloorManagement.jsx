...
const FloorManagement = ({floor, onClickOperate }) => {
    ...
    useEffect(() => {
        requestSiteDeviceList({ siteId: floor.site.siteId }, (res) => {
            if (res.result == 1) {
                setDeviceList(res.data);
            }
            requestGetDoorList({...query,floorId:floor.floorId});
        });
    },[floor]);
    ...
    const onClickEditDoor = (door) => {
        ...
        setEditDoorData({ ...door, siteName: floor.site.siteName, floorOptions: floor.site.floors, deviceOptions: getDeviceOptions(door.devices, deviceList) });
    }
        ...
        let modal = UIModalConfirm(
            {
                ...
                onOk: (close) => {
                    ...
                    let params = {
                        floorId: floor.floorId,
                        doorId: doorId,
                        siteId: floor.site.siteId,
                    }
                    requestRemoveAssocFloor(params, (res) => {
                        if (res.result == 1) {
        ...
        let modal = UIModalConfirm(
            {
                ...
                onOk:(close)=>{
                    ...
                    requestAddAssocFloor(params, (res) => {
                        if(res.result == 1){
    ...
    const requestGetDoorList=(query)=>{
        ...
        const params = {
          ...
          Http.getFloorDoorList(params, (res) => {
            if(res.result == 1){
    ...
    const requestAddAssocFloor = (params, success) => {
        
            Http.addAssocFloor(params, success);
        
    }

    const requestRemoveAssocFloor = (params, success) => {
        Http.removeAssocFloor(params, success);
    }
